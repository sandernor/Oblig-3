...
//   mVertices.push_back(Vertex0{0,1,0,0,0,1});

//   mVertices.push_back(Vertex0{0,0,0,1,1,0});
//   mVertices.push_back(Vertex0{1,0,0,1,1,0});
//   mVertices.push_back(Vertex0{0,0,1,1,1,0});
//}

//void TETRA::init(GLuint mVAO, GLuint mVBO)
//{
