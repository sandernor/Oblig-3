...
const QVector3D& v3)
{
//   Vertex v{v1.x(), v1.y(), v1.z(), 1, 0, 0};
//   mVertices.push_back(v);
//   v = Vertex{v2.x(), v2.y(), v2.z(), 0, 1, 0};
//   mVertices.push_back(v);
//   v = Vertex{v3.x(), v3.y(), v3.z(), 0, 0, 1};
//   mVertices.push_back(v);
...
//      Vertex v{v1.x(), v1.y(), v1.z(), ((v1.x()+1)/2), ((v1.y()+1)/2), ((v1.z()+1)/2)};
//      mVertices.push_back(v);
//      v = Vertex{v2.x(), v2.y(), v2.z(), ((v2.x()+1)/2), ((v2.y()+1)/2), ((v2.z()+1)/2)};
//      mVertices.push_back(v);
//      v = Vertex{v3.x(), v3.y(), v3.z(), ((v3.x()+1)/2), ((v3.y()+1)/2), ((v3.z()+1)/2)};
//      mVertices.push_back(v);

         Vertex v{v1.x(), v1.y(), v1.z(), 0.6f, 0.6f, 1};
         mVertices.push_back(v);
         v = Vertex{v2.x(), v2.y(), v2.z(), 1, 0.6f, 0.6f};
         mVertices.push_back(v);
         v = Vertex{v3.x(), v3.y(), v3.z(), 0.6f, 1, 0.6};
         mVertices.push_back(v);
}
